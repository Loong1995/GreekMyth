	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord123 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float Random_Offset159 = input.ase_texcoord5.x;
				...
				float Opacity_VTC_W158 = input.ase_texcoord4.z;
				float temp_output_208_0 = saturate( Opacity_VTC_W158 );
				float2 texCoord230 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 panner140 = ( 1.0 * _Time.y * _MaskUVPan + ( texCoord131 * _MaskUVScale ));
				float2 texCoord123 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult151 = (float2(_FlipbookX , _FlipbookY));
				float2 FlipbookFrames220 = appendResult151;
				float2 panner127 = ( 1.0 * _Time.y * _DistortionUVPan + ( ( texCoord123 * _DistortionUVScale ) * FlipbookFrames220 ));
				float Random_Offset159 = input.ase_texcoord3.x;
				float2 lerpResult139 = lerp( float2( 0,0 ) , ( ( (tex2D( _DistortionTexture, ( panner127 + Random_Offset159 ) )).rg + -0.5 ) * 2.0 ) , _DistortionLerp);
				float2 PrePixelateUVs149 = ( panner140 + lerpResult139 );
				float pixelWidth115 =  1.0f / ( _PixelsX * _PixelsMultiplier );
				float pixelHeight115 = 1.0f / ( _PixelsY * _PixelsMultiplier );
				...
				float lerpResult186 = lerp( tex2DNode185.g , tex2DNode185.r , saturate( _AlphaGlow ));
				float mainTex_alpha48 = saturate( lerpResult186 );
				float Opacity_VTC_W158 = input.ase_texcoord2.z;
				float temp_output_208_0 = saturate( Opacity_VTC_W158 );
				float2 texCoord230 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner216 = ( 1.0 * _Time.y * _ErosionNoiseUVPan + ( ( texCoord230 * FlipbookFrames220 ) * _ErosionNoiseUVScaleOverall ));
				float2 DistortUVs231 = lerpResult139;
				float smoothstepResult200 = smoothstep( temp_output_208_0 , ( temp_output_208_0 + _ErosionSmoothness ) , tex2D( _ErosionNoise, ( ( panner216 + Random_Offset159 ) + DistortUVs231 ) ).g);
				float lerpResult196 = lerp( mainTex_alpha48 , saturate( ( mainTex_alpha48 * saturate( smoothstepResult200 ) ) ) , _ErosionIntensity);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_Unlit_Combat_Flipbook_Advanced_01_WebGL;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;0;True;12;all;0;True;True;2;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638490814449923107;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638689913380789699;  Use Shadow Threshold;0;0;Cast Shadows;0;638490812733195615;Receive Shadows;0;638689913394536334;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;638689913409654563;Built-in Fog;0;638689913418545696;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;232;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=63CC99CB6905C14C49BCD348B25623A38889CCCB